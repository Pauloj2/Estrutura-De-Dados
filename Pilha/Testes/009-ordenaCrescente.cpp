...
struct Stack {
    ...
    void sort() {
        Stack auxStack; // Pilha auxiliar para ordenar a pilha original
        ...
        while (!empty()) {
            ...
            // enquanto forem maiores que o elemento atual
        ...
        // Restaure a pilha original da pilha auxiliar (ordenada)
